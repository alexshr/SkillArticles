...
*/
        ...
        private var content: List<MarkdownElement> by ObserveProp(emptyList()) {
            ...
            if (it.isNotEmpty()) setupCopyListener()//для всех MarkdownCodeView
        }

        //инициализация в BaseActivity.onCreate
        ...
        override fun onFinishInflate() {
            dependsOn<Boolean, Boolean, List<Pair<Int, Int>>, Int>(
                ...
                if (!_isLoadingContent && _isSearch) {
                    //выделить результат поиска
                    tv_text_content.renderSearchResult(_searchResults)
                    //выделить текущую позицию поиска
